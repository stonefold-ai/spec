...
*Non-normative companion. The normative basis is one sentence in the SIF specification §7
...
bindings, normative), [`02-implementation-design.md`](https://github.com/stonefold-ai/stonefold/blob/main/docs/02-implementation-design.md) §1.2
...
[`16-incremental-adoption.md`](https://github.com/stonefold-ai/stonefold/blob/main/docs/16-incremental-adoption.md) (the adoption ramp this binding
anchors).
