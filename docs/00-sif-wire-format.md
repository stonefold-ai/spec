# SIF — the Structured Intent Format (v0.3)
...
**Status:** v0.3. This is the wire format the reference gateway speaks, documented so an independent implementation can speak it too.
**Layer:** SIF is the lower layer — it defines *what the agent can say*. The **Stele** spec ([`01-stele-policy-language.md`](01-stele-policy-language.md)) is the upper layer — it defines *what the agent is allowed to do*. Stele references this document for the action kinds and the intent shape.
