...
| **Stele policy** ([`01`](01-stele-policy-language.md)) | the **security / policy officer** | often; **signed** | trusted, signed | *what's allowed:* allow/deny/scope/gates |
| **SIF intent** ([`00`](00-sif-wire-format.md)) | the **agent (LLM), at runtime** | every request | **untrusted** | *what's wanted:* one batch of typed operations |
